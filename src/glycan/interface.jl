...
getchemicalattr(mono::T, ::Val{:abbreviation}; kwargs...) where {T <: AbstractHexose} = add_sub(mono, uppercasefirst(first(string(T.name.name), 3)))
getchemicalattr(mono::Glucose, ::Val{:abbreviation}; kwargs...) = add_sub(mono, "Glc")
...
getchemicalattr(mono::T, ::Val{:abbreviation}; kwargs...) where {T <: AbstractHexosamine} = add_sub(mono, string(uppercasefirst(first(string(T.name.name), 3)), "N"))
getchemicalattr(mono::Glucosamine, ::Val{:abbreviation}; kwargs...) = add_sub(mono, "GlcN")
getchemicalattr(mono::T, ::Val{:abbreviation}; kwargs...) where {T <: AbstractNacetylhexosamine} = add_sub(mono, string(uppercasefirst(string(T.name.name)[begin + 7:begin + 9]), "NAc"))
getchemicalattr(mono::Nacetylgluosamine, ::Val{:abbreviation}; kwargs...) = add_sub(mono, "GlcNAc")
getchemicalattr(mono::T, ::Val{:abbreviation}; kwargs...) where {T <: AbstractHexuronicAcid} = add_sub(mono, string(uppercasefirst(first(string(T.name.name), 3)), "A"))
getchemicalattr(mono::GlucuronicAcid, ::Val{:abbreviation}; kwargs...) = add_sub(mono, "GlcA")
getchemicalattr(mono::NeuraminicAcid, ::Val{:abbreviation}; kwargs...) = add_sub(mono, "Neu")
getchemicalattr(mono::NacetylneuraminicAcid, ::Val{:abbreviation}; kwargs...) = add_sub(mono, "Neu5Ac")
getchemicalattr(mono::NglycolylneuraminicAcid, ::Val{:abbreviation}; kwargs...) = add_sub(mono, "Neu5Gc")
getchemicalattr(mono::Kdn, ::Val{:abbreviation}; kwargs...) = add_sub(mono, "Kdn")
getchemicalattr(mono::Inositol, ::Val{:abbreviation}; kwargs...) = add_sub(mono, "Ino")
...
getchemicalattr(mono::T, ::Val{:name}; kwargs...) where {T <: Monosaccharide} = add_name(mono, string(T.name.name))
getchemicalattr(mono::T, ::Val{:name}; kwargs...) where {T <: AbstractNacetylhexosamine} = add_name(mono, replace(string(T.name.name), "Nacetyl" => "N-acetyl"))
getchemicalattr(mono::T, ::Val{:name}; kwargs...) where {T <: AbstractHexuronicAcid} = add_name(mono, replace(string(T.name.name), "Acid" => " acid"))
getchemicalattr(mono::NacetylneuraminicAcid, ::Val{:name}; kwargs...) = add_name(mono, "N-acetylneuraminic acid")
getchemicalattr(mono::NglycolylneuraminicAcid, ::Val{:name}; kwargs...) = add_name(mono, "N-glycolylneuraminic acid")
getchemicalattr(mono::Kdn, ::Val{:name}; kwargs...) = add_name(mono, "Keto-deoxy-glycero-galactonononic acid")
